<?php
    ...
    try{
        ...
        $resultado = [
            'mensaje' => 'SE HA ELIMINACO EL AREA SATISFACTORIAMENTE',
            'codigo' => 1
        ];
        
    } catch (PDOException $pe){
        $resultado = [
            'mensaje' => 'HA OCURRIDO UN ERROR AL INTENTAR ELIMINAR EL AREA ',
...
<div class="row justify-content-center">
    <div class="col-lg-6">
        <a href="../../controladores/areas/buscar.php" class="btn btn-primary w-100">VOLVER A LA BUSQUEDA DE DATOS</a>
    </div>
</div>
