<nav class="navbar fixed-top navbar-expand-lg bg-secondary">
  <div class="container-fluid">
    <a class="navbar-brand" href="../../vistas/empleado/index.php"><i class="bi bi-wrench-adjustable-circle-fill"></i>INGESOFT S.A.</a>
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0" style="--bs-scroll-height: 100px;">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../../vistas/empleado/index.php"><i class="bi bi-houses-fill"></i>INICIO</a>
        </li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="bi bi-file-person me-2"></i>ASIGNACION DE AREAS
          </a>
          <ul class="dropdown-menu bg-secondary">
            <li><a class="dropdown-item" href="../../vistas/asignacion/index.php"><i class="bi bi-plus-circle me-2"></i>INGRESAR</a></li>
            <li><a class="dropdown-item" href="../../vistas/asignacion/buscar.php"><i class="bi bi-search me-2"></i>BUSCAR</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="bi bi-file-person me-2"></i>TABLA DE ORGANIZACION POR AREAS
          </a>
          <ul class="dropdown-menu bg-secondary">
            <li><a class="dropdown-item" href="../../vistas/organizacion_areas/index.php" class="bi bi-plus-circle me-2"></i>INGRESAR</a></li>
          </ul>
        </li>
    </div>
  </div>
